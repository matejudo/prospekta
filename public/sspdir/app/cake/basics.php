<?php
/* SVN FILE: $Id: basics.php 4983 2007-05-02 08:36:06Z phpnut $ */
/**
 ...
 */
	function __($singular, $return = false) {
		...
		if($return === false) {
			echo I18n::translate($singular, null, null, 5, null, null);
		} else {
			return I18n::translate($singular, null, null, 5, null, null);
		}
	}
/**
 *
 ...
 */
	function __n($singular, $plural, $count, $return = false) {
		...
		if($return === false) {
			echo I18n::translate($singular, $plural, null, 5, $count, null);
		} else {
			return I18n::translate($singular, $plural, null, 5, $count, null);
		}
	}
/**
 *
 ...
 */
	function __c($msg, $category, $return = false) {
		...
		if($return === false) {
			echo I18n::translate($msg, null, null, $category, null, null);
		} else {
			return I18n::translate($msg, null, null, $category, null, null);
		}
    }
/**
