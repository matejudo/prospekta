 ...
 */
	...
	if (empty($self)) {
		...
		define('BASE_URL', $self . '?');
	}

	if (strpos(strtoupper(env('SERVER_SOFTWARE')), 'IIS') !== false) {
 ...
 *
 */
	// Change the zero in the line below to a 1 to enable debug mode
	define('DEBUG', 0);
 ...
 *
 */
 	define('CAKE_SESSION_STRING', '4DG5as8235231r6f13f864as544s4Qt3ua13TzfAf4');
/**
